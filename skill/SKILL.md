...
**Canonical body:** `skill/SKILL.md` at the playwrighter repo root. Resolve `patterns/`, `templates/`, and `tools/` paths relative to that repo root (not relative to a vendor-specific skill install directory).
